                ...
                {profile ? (
                    <>
                        <Route element={<Layout />}>
                            ...
                            <Route
                                path={`/${Resource.Users.toLowerCase()}/list`}
                                element={<Navigate to={`/${Resource.Users.toLowerCase()}`} />}
                            />
                            ...
                            <Route
                                path={`/${Resource.Roles.toLowerCase()}/list`}
                                element={<Navigate to={`/${Resource.Roles.toLowerCase()}`} />}
                            />
                            ...
                            <Route
                                path={`/${Resource.ApprovalProfiles.toLowerCase()}/detail/:id/:version`}
                                element={<ApprovalProfileDetails />}
                            />
                            ...
                            />
                            <Route
                                path={`/${Resource.ComplianceProfiles.toLowerCase()}/detail/:id`}
                                element={<ComplianceProfileDetail />}
                            />
                            ...
                            />
                            <Route
                                path={`/${Resource.AcmeAccounts.toLowerCase()}/detail/:acmeProfileId/:id`}
                                element={<AcmeAccountDetail />}
                            />
                            ...
                            />
                            <Route
                                path={`/${Resource.VaultProfiles.toLowerCase()}/detail/:vaultUuid/:id`}
                                element={<VaultProfileDetail />}
                            />
                            ...
                            <Route
                                path={`/${Resource.Keys.toLowerCase()}/list`}
                                element={<Navigate to={`/${Resource.Keys.toLowerCase()}`} />}
                            />
                            ...
                            <Route
                                path={`/${Resource.Jobs.toLowerCase()}/list`}
                                element={<Navigate to={`/${Resource.Jobs.toLowerCase()}`} />}
                            />
                            ...
                            <Route
                                path={`/${Resource.Cboms.toLowerCase()}/detail/:id/versions/:versionId?`}
                                element={<CbomVersionsHistory />}
                            />
                        </Route>
                    ...
                    <Route path="*" element={<Spinner size="xl" />} />
                )}
            </Routes>
        </HashRouter>
    );
